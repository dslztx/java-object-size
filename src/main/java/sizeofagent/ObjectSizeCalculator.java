...
public class ObjectSizeCalculator {
    ...
    private final LoadingCache<Class<?>, ClassSizeInfo> classSizeInfos = CacheBuilder.newBuilder().build(
            new CacheLoader<Class<?>, ClassSizeInfo>() {
    ...
    static MemoryLayoutSpecification getEffectiveMemoryLayoutSpecification() {
        ...
        if (vmName == null
                || !(vmName.startsWith("Java HotSpot(TM) ") || vmName.startsWith("OpenJDK") || vmName
                        .startsWith("TwitterJDK"))) {
        ...
        if ("32".equals(dataModel)) {
            ...
            throw new UnsupportedOperationException("Unrecognized value '" + dataModel
                    + "' of sun.arch.data.model system property");
        }
